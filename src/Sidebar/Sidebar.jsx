  ...
  return (
    <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <nav className="nav-menu">
        ...
        {/* Festival tab navigation items */}
        {activeTab === "Festival" && (
          <>
            <div 
              className={`nav-item ${activeItem === "stalls" ? "active" : ""}`}
              onClick={() => handleItemClick("stalls")}
            >
              <div className="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="nav-label">Stalls</span>
            </div>

            <div 
              className={`nav-item ${activeItem === "touristSpots" ? "active" : ""}`}
              onClick={() => handleItemClick("touristSpots")}
            >
              <div className="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
